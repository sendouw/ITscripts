...
*Initial commit sourced from my privatized internal toolkit.*
...
3. For GUI experiences (`liveMigrationTool`, `RoboCopy`), launch via `powershell.exe -ExecutionPolicy Bypass -File .\\ScriptName.ps1`. Console-only utilities can be dot-sourced or invoked directly.
